...
### Open RDrive
<img align="right" src="https://github.com/Ost268/SAMSUNG-WINNER-WindowsARM/blob/main/Screen1.png" width="350" alt="RDrive">
Click Restore from an Image
```open image  E_HDD5-image.rdr
```Click Restore disk or partitions and click next

<img align="right" src="https://github.com/Ost268/SAMSUNG-WINNER-WindowsARM/blob/main/Screen2.png" width="350" alt="RDrive">
